    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Shoot0 = follower.pathBuilder()
                    .addPath(
                            new BezierLine(
                                    new Pose(62.805, 9.163),
                                    new Pose(56.000, 18.388)
                            )
                    )
            ...
            IntakeA = follower.pathBuilder()
                    .addPath(
                            new BezierCurve(
                                    new Pose(56.000, 18.388),
                                    new Pose(49.736, 35.476),
                                    new Pose(13.176, 34.742)
                            )
                    )
            ...
            IntakeB = follower.pathBuilder()
                    .addPath(
                            new BezierCurve(
                                    new Pose(55.860, 18.388),
                                    new Pose(51.591, 55.571),
                                    new Pose(20.506, 56.635)
                            )
                    )
                    .setTangentHeadingInterpolation()
                    .setReversed()
